...
if __name__ == "__main__":
    ...
    data = AttrDict(data)
    model = build_vit(data)

    import torch

    # checkpoint = torch.load("/home/jackson/Desktop/Paper/pretrain_model/simmim_pretrain__vit_base__img224__800ep.pth")
    # # model.load_state_dict(checkpoint["model"])
    # from model.utils.utils import load_pretrained
    # from logger import create_logger
    # logger = create_logger("../../")
    # load_pretrained(data, model, logger)
    # print(model)
    # new_check_point = {}
    # for key, value in checkpoint["model"].items():
    #     if key.startswith("encoder") and key != "encoder.mask_token":
    #         new_check_point[key[8:]] = value
    #
    new_check_point = torch.load("/home/jackson/Desktop/Paper/pretrain_model/vit_base_image224_800ep.pt")
    model.load_state_dict(new_check_point)
    # torch.save(new_check_point, "/home/jackson/Desktop/Paper/pretrain_model/vit_base_image224_800ep.pt")
